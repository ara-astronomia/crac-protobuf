...
import crac_protobuf.chart_pb2 as chart__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in chart_pb2_grpc.py depends on'
...
def add_WeatherServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.GetStatus,
                    request_deserializer=chart__pb2.WeatherRequest.FromString,
                    response_serializer=chart__pb2.WeatherResponse.SerializeToString,
            ),
    }

...
_TELESCOPESPEED = _descriptor.EnumDescriptor(
  name='TelescopeSpeed',
  full_name='TelescopeSpeed',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='TRACKING', index=1, number=1,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CENTERING', index=2, number=2,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='SLEWING', index=3, number=3,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_sym_db.RegisterEnumDescriptor(_TELESCOPESPEED)
...
_TELESCOPEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='autolight', full_name='TelescopeRequest.autolight', index=1,
...
_EQUATORIALCOORDS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='ra', full_name='EquatorialCoords.ra', index=0,
...
_TELESCOPERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='speed', full_name='TelescopeResponse.speed', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sync', full_name='TelescopeResponse.sync', index=4,
...
_TELESCOPERESPONSE.fields_by_name['speed'].enum_type = _TELESCOPESPEED
...
DESCRIPTOR.enum_types_by_name['TelescopeSpeed'] = _TELESCOPESPEED
